...
#ifndef STROBE_MODES_CLASSIC_H
#define STROBE_MODES_CLASSIC_H
...
typedef enum {
    ...
    bike_flasher_e,
    #endif
    strobe_mode_classic_END
} strobe_mode_classic_te;

const int NUM_STROBES_CLASSIC = strobe_mode_classic_END;

// which strobe mode is active?
#ifdef USE_CANDLE_MODE
strobe_mode_classic_te strobe_type_classic = candle_mode_e;
#else
strobe_mode_classic_te strobe_type_classic = 0;
#endif
#endif
